...
const buttonVariants = cva(
  "base-button transition-color duration-300 inline-flex items-center justify-center rounded-full gap-[10px] text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
